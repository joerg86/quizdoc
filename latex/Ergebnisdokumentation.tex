...
Nachdem alle Spieler ihre Frage abgesendet haben, beginnt die erste Fragephase automatisch.
	...
	Die grafische Oberfläche gliedert sich in drei Bereiche:
	
	\begin{enumerate}
		\item \textit{Home} ist die Landing Page des Q-Teams-Projektes. Sie stellt mithilfe des Projektvideos das Konzept vor.
		\item Im Bereich \textit{Spielen} können Teams erstellt werden und das Quiz gespielt werden.
		\item Die \textit{Knowledge Base} stellt den Zugang zu bereits gespielten Fragen aller Spieler bereit und dient als Inspiration für eigene fachliche Fragen.
	\end{enumerate}
