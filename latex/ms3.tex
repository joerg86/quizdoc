...
\end{figure}
	...
	Die Antworten und Bewertungen werden zwischen dem Spieler und dem Rest des Q-Teams geklärt. Ist das Q-Team wieder bereit wird der nächste \nameref{subsec:phasenuebergang} geprüft.
	...
	Die Qualität ist das Ausmaß, in dem die dem Produkt, Prozess, der Organisation oder dem System innewohnenden Merkmale die Anforderungen erfüllen (\cite{Prince2}, S. 78). Aufgrund des sich dadurch ergebenden hohen Stellenwertes der Qualität, ist diese durch koordinierte Aktivitäten sicherzustellen. Diese Aktivitäten werden unter dem Begriff Qualitätsmanagement zusammengefasst.
	Dieses Kapitel beschreibt die Organisation und Ziele des Qualitätmanagements des Projekts. Es stellt außerdem ausgewählte Maßnahmen der Qualitätssicherung vor und überträgt sie auf das Projekt.
...
Die Werkzeuge \textit{JSLint}\footnote{https://jslint.com/} und \textit{Pylint}\footnote{https://www.pylint.org/} werden im Projekt zur statischen Codeanalyse verwendet. Sie können in die Entwicklungsumgebung integriert werden und liefern dem Entwickler Hinweise zu Programmierkonventionen und fördern eine leserliche Code-Struktur.
