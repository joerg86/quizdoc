...
\begin{center}
\Large
\bfseries\textit{\frqq{}Q-Teams: Fragen. Antworten. Teilen.\flqq{}}
\end{center}
...
\begin{itemize}
	...
	\item der geschätzte Projektumfang beträgt nur 53,5 Personentage (vgl. Abschnitt \nameref{sec:aufwand}), wobei mehr als die Hälfte auf die gemäß Projektauftrag geforderte Dokumentation entfällt
...
% IMHO gehört es zu Projektstruktur und Ablauf
%	\newpage			
...
Im zweiten Teil des am Donnerstag stattfindenden Jour fixe wird die Sprintplanung durchgeführt (vgl. Abschnitt \nameref{sec:kommunikationsmanagement}). Zunächst wird das Sprintziel ausdifferenziert. Der nächste zu erfüllende Meilenstein gibt dabei den Rahmen vor. 
...
\subsection{\glslink{git}{Quellcode-Repositories}}
...
Während der Projektkonfiguration wurde während eines Jour fixe ein Brainstorming zu Risiken durchgeführt. Zum Festhalten der Risiken ist im Redmine ein Risikoregister verfügbar (siehe Abschnitt \nameref{subsec:risikoregister}). Im weiteren Verlauf des Projekts können alle Teammitglieder jederzeit weitere Risiken vorbringen und im Risikoregister aufnehmen .

\subsection{Bewerten}

Der Risikoautor, d.h. die Person, die das Risiko gemeldet hat, führt die Risikobewertung gemäß des Abschnitts \nameref{subsec:bewertungsskalen} durch. Das Ergebnis der Bewertung wird im Risikoregister festgehalten.
...
Die Kommunikation findet gemäß des Kommunikationsmanagementansatzes statt (siehe Abschnitt \nameref{sec:kommunikationsmanagement}). Risiken, die durch den Risikoautor mit dem höchsten Schweregrad bewertet werden, sind sofort an den Teamleiter zu melden. Alle weiteren Risiken sind im Risikoregister aufzunehmen. Während des Jour fixe gibt der Teamleiter ausgewählte Risiken an das Team weiter.
...
Aus der Eintrittswahrscheinlichkeit und der Auswirkung wird mit Hilfe der \nameref{fig:risiko} (siehe Abbildung \ref{fig:risiko} auf Seite \pageref{fig:risiko}) der Schweregrad ermittelt. Dieser wird wiederum in vier Stufen angegeben:
...
Die Eintrittsnähe wird bezüglich der Projektmeilensteine angegeben. Dabei wird ein Zeitraum von Beginn bis Ende des möglichen Eintrittszeitraums angegeben, z.B. bedeutet \frqq{}MS 2 bis MS 3\flqq{} von Abschluss des Meilensteins 1 bis zum Abschluss des Meilensteins 3.
